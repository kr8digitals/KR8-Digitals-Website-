    ...
    return (
      <div className="section-bg min-h-screen py-14">
        <div className="mx-auto max-w-4xl px-5">
          ...
          <h1 className="font-display mt-4 text-3xl sm:text-5xl leading-tight text-white font-black">
            {active.title}
          </h1>
      ...
      <div className="mx-auto max-w-7xl px-5 py-14">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-6">
          <div>
            ...
            <h1 className="font-display mt-4 text-4xl sm:text-6xl text-white font-black">
