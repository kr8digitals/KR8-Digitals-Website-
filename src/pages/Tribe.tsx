    ...
    <div>
      ...
      <section className="section-bg overflow-hidden py-16">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 lg:grid-cols-2">
          <div>
            ...
            <h1 className="font-display mt-5 text-4xl leading-[0.98] text-white sm:text-6xl font-bold">
      ...
      <section className="section-bg py-16">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 lg:grid-cols-3">
          <Card>
            <h3 className="font-display text-2xl font-bold text-white">Who Can Join</h3>
          ...
          <Card>
            <h3 className="font-display text-2xl font-bold text-white">Programs</h3>
          ...
          <Card>
            <h3 className="font-display text-2xl font-bold text-white">Tribe Rules</h3>
            <ul className="mt-4 space-y-3">
              {rules.map((r) => (
                <Check key={r}>{r}</Check>
              ))}
